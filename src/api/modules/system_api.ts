...
/** ChartMapDataVO */
export interface ChartMapDataVO {
  /** @format double */
  lat?: number;
  /** @format double */
  lng?: number;
...
/** EnableAccountFailureVO */
export interface EnableAccountFailureVO {
  /** 失败原因 */
  failReason?: string;
  /** 真实名称 */
  realName?: string;
...
/**
 * R«List«ChartMapDataVO»»
 * 返回信息
 */
export interface RListChartMapDataVO {
  /**
   * 状态码
   * @format int32
   */
...
/**
 * R«List«EnableAccountFailureVO»»
 * 返回信息
 */
export interface RListEnableAccountFailureVO {
  /**
   * 状态码
   * @format int32
   */
 ...
 * 返回信息
 */
export interface RListTreeTestVO {
  /**
   * 状态码
   * @format int32
   */
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  bladeSystem = {
     ...
     * @name PostExportPost
     * @summary 导出岗位
     * @request GET:/blade-system/post/export-post
     * @secure
     */
    postExportPost: (
      query?: {
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestAlarmCard
     * @summary 设备报警卡片（轮播组件） 数据格式
     * @request POST:/blade-system/test/alarmCard
     * @secure
     */
    chartTestAlarmCard: (params: RequestParams = {}) =>
      this.request<RChartDataTableVO, void>({
        path: `/blade-system/test/alarmCard`,
        method: 'POST',
        secure: true,
        type: ContentType.Json,
        ...params,
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestColorBlock
     * @summary 颜色块数据, 名称数据
     * @request POST:/blade-system/test/colorBlock
     * @secure
     */
    chartTestColorBlock: (params: RequestParams = {}) =>
      this.request<RChartNameValueDataVO, void>({
        path: `/blade-system/test/colorBlock`,
        method: 'POST',
        secure: true,
        type: ContentType.Json,
        ...params,
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestGanttStatusDataVo
     * @summary 甘特图状态数据
     * @request GET:/blade-system/test/gantt
     * @secure
     */
    chartTestGanttStatusDataVo: (params: RequestParams = {}) =>
      this.request<RChartGanttStatusDataVO, void>({
        path: `/blade-system/test/gantt`,
        method: 'GET',
        secure: true,
        ...params,
      }),
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestGaugeDataVo
     * @summary 仪表盘数据（键值对）
     * @request GET:/blade-system/test/gauge
     * @secure
     */
    chartTestGaugeDataVo: (params: RequestParams = {}) =>
      this.request<RChartNameValueDataVO, void>({
        path: `/blade-system/test/gauge`,
        method: 'GET',
        secure: true,
        ...params,
      }),
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestEChartMapDataVo
     * @summary 地图数据
     * @request GET:/blade-system/test/map
     * @secure
     */
    chartTestEChartMapDataVo: (params: RequestParams = {}) =>
      this.request<RListChartMapDataVO, void>({
        path: `/blade-system/test/map`,
        method: 'GET',
        secure: true,
        ...params,
      }),
     ...
     * @name ChartTestPie
     * @summary 饼图数据， 键值对
     * @request POST:/blade-system/test/pie
     * @secure
     */
    chartTestPie: (params: RequestParams = {}) =>
      this.request<RChartNameValueDataVO, void>({
        path: `/blade-system/test/pie`,
        method: 'POST',
        secure: true,
        type: ContentType.Json,
        ...params,
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestProgressData
     * @summary 进度条，环形图， 键值对
     * @request POST:/blade-system/test/progress
     * @secure
     */
    chartTestProgressData: (params: RequestParams = {}) =>
      this.request<RChartNameValueDataVO, void>({
        path: `/blade-system/test/progress`,
        method: 'POST',
        secure: true,
        type: ContentType.Json,
        ...params,
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestScatterDataVo
     * @summary 散点图
     * @request POST:/blade-system/test/scatter
     * @secure
     */
    chartTestScatterDataVo: (params: RequestParams = {}) =>
      this.request<RChartSeriesDataVO, void>({
        path: `/blade-system/test/scatter`,
        method: 'POST',
        secure: true,
        type: ContentType.Json,
        ...params,
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestGetSelectData
     * @summary 下拉测试
     * @request GET:/blade-system/test/select
     * @secure
     */
    chartTestGetSelectData: (params: RequestParams = {}) =>
      this.request<RListChartSelect, void>({
        path: `/blade-system/test/select`,
        method: 'GET',
        secure: true,
        ...params,
      }),
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestSeriesDataVo
     * @summary 单图例
     * @request POST:/blade-system/test/series
     * @secure
     */
    chartTestSeriesDataVo: (params: RequestParams = {}) =>
      this.request<RChartSeriesDataVO, void>({
        path: `/blade-system/test/series`,
        method: 'POST',
        secure: true,
        type: ContentType.Json,
        ...params,
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestSeries2DataVo
     * @summary 多图例
     * @request POST:/blade-system/test/series2
     * @secure
     */
    chartTestSeries2DataVo: (params: RequestParams = {}) =>
      this.request<RChartSeriesDataVO, void>({
        path: `/blade-system/test/series2`,
        method: 'POST',
        secure: true,
        type: ContentType.Json,
        ...params,
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestTableDataVo
     * @summary 表格数据
     * @request GET:/blade-system/test/table
     * @secure
     */
    chartTestTableDataVo: (
      query: {
        /**
         * length
         * @format int32
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestGetTreeSelectVo
     * @summary 树数据测试
     * @request GET:/blade-system/test/tree
     * @secure
     */
    chartTestGetTreeSelectVo: (params: RequestParams = {}) =>
      this.request<RListTreeTestVO, void>({
        path: `/blade-system/test/tree`,
        method: 'GET',
        secure: true,
        ...params,
      }),
     ...
     *
     * @tags echart数据类型测试
     * @name ChartTestWorkSelect
     * @summary 下拉测试
     * @request GET:/blade-system/test/workSelect
     * @secure
     */
    chartTestWorkSelect: (params: RequestParams = {}) =>
      this.request<RListWorkstationVO, void>({
        path: `/blade-system/test/workSelect`,
        method: 'GET',
        secure: true,
        ...params,
      }),
  ...
  bladeUser = {
    ...
    userBatchEnableAccount: (batchEnableAccountVO: BatchEnableAccountVO, params: RequestParams = {}) =>
      this.request<RListEnableAccountFailureVO, void>({
