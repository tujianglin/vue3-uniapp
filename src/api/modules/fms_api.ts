...
/** ProgramIssuanceDTO */
export interface ProgramIssuanceDTO {
  /** 设备编号 */
  deviceCode?: string;
  /** 下发程序工单工序id */
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  bladeFms = {
    ...
    /**
     * @description programIssuanceDTO
     *
     * @tags fms_order_process
     * @name FmsOrderProcessSendProgram
     * @summary 南通柔性线程序下发
     * @request POST:/blade-fms/order/process/issued
     * @secure
     */
    fmsOrderProcessSendProgram: (programIssuanceDTO: ProgramIssuanceDTO, params: RequestParams = {}) =>
      this.request<void, void>({
        path: `/blade-fms/order/process/issued`,
        method: 'POST',
        body: programIssuanceDTO,
        secure: true,
        type: ContentType.Json,
        ...params,
      }),
