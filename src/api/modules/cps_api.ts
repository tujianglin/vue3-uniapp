...
/** CommonGroupFtpVO */
export interface CommonGroupFtpVO {
  /**
   * 工位内部存储区分
   * @format int32
   */
...
/**
 * R«ProcessAssociationDetailVO»
 * 返回信息
 */
export interface RProcessAssociationDetailVO {
  /**
   * 状态码
   * @format int32
   */
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  bladeCps = {
     ...
     * @secure
     */
    checkProjectExportCheckProject: (
      query?: {
        /**
         * 状态：1 启用 0 停用
         * @format int32
     ...
     * @summary 导出员工
     * @request GET:/blade-cps/employee/export-employee
     * @secure
     */
    employeeExportEmployee: (
      query?: {
        /** 关键词：员工编号/员工姓名 */
        keyword?: string;
        /** 组织code */
     ...
     * @secure
     */
    employeeTree: (params: RequestParams = {}) =>
     ...
     *
     * @tags 组
     * @name CommonGroupGroupFtpDirectoryLazy
     * @summary 查询未被绑定目录的所有组和工位
     * @request POST:/blade-cps/group/groupFtpDirectory/ftp
     * @secure
     */
    commonGroupGroupFtpDirectoryLazy: (commonGroupFtpVO: CommonGroupFtpVO, params: RequestParams = {}) =>
      this.request<RListWorkstationInGroupVO, void>({
        path: `/blade-cps/group/groupFtpDirectory/ftp`,
        method: 'POST',
        body: commonGroupFtpVO,
        secure: true,
        type: ContentType.Json,
        ...params,
      }),
     ...
     * @name InitGetApp
     * @summary 获得APP设置
     * @request GET:/blade-cps/init/get-app
     * @secure
     */
    initGetApp: (params: RequestParams = {}) =>
      this.request<RListAppVO, void>({
        path: `/blade-cps/init/get-app`,
        method: 'GET',
        secure: true,
        ...params,
      }),
     ...
     * @secure
     */
    initLicenseDetail: (params: RequestParams = {}) =>
     ...
     * @secure
     */
    malfunctionTypeExportMalfunctionType: (
      query?: {
        /**
         * 1 启用 0 停用
         * @format int32
     ...
     * @summary 导出组织
     * @request GET:/blade-cps/organization/export-organization
     * @secure
     */
    ...
    processAssociationSave: (processAssociationSaveVO: ProcessAssociationSaveVO, params: RequestParams = {}) =>
      this.request<RProcessAssociationDetailVO, void>({
     ...
     * @summary 导出工序
     * @request GET:/blade-cps/process/export-process
     * @secure
     */
    processExportProcess: (
      query?: {
        /** keyword */
        keyword?: string;
        /**
