...
import { p as pathBrowserify, l as lib } from './MonacoEditor-199c6725.js';
import 'vue';
...
function nextJSONToken(_state, _out) {
  ...
  if (chCode === 34 /* QUOTATION_MARK */) {
    ...
    _out.value = source
      ...
      .replace(/\\u([0-9A-Fa-f]{4})/g, function (_, m0) {
        return String.fromCodePoint(parseInt(m0, 16));
      })
    ...
    do {
      ...
      chCode = source.charCodeAt(pos);
      if (chCode === 46 /* DOT */ || (chCode >= 48 /* D0 */ && chCode <= 57) /* D9 */ || chCode === 101 /* e */ || chCode === 69 /* E */ || chCode === 45 /* MINUS */ || chCode === 43 /* PLUS */) {
  ...
  Registry.prototype.loadGrammarWithConfiguration = function (initialScopeName, initialLanguage, configuration) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this._loadGrammar(initialScopeName)];
          case 1:
            _a.sent();
            ...
            prom = new Promise(function (resolve, reject) {
              return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/, this._locator.getGrammarDefinition(initialScopeName, dependentScope)];
                    case 1:
