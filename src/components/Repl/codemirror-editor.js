      ...
      function highlightWorker(cm) {
        ...
        doc.iter(context.line, Math.min(doc.first + doc.size, cm.display.viewTo + 500), function (line) {
          if (context.line >= cm.display.viewFrom) {
            ...
            var ischange =
              !oldStyles || oldStyles.length != line.styles.length || (oldCls != newCls && (!oldCls || !newCls || oldCls.bgClass != newCls.bgClass || oldCls.textClass != newCls.textClass));
      ...
      function leftButtonSelect(cm, event, start, behavior) {
        ...
        function extendTo(pos) {
          ...
          if (behavior.unit == 'rectangle') {
            ...
            setSelection(doc$1, normalizeSelection(cm, startSel.ranges.slice(0, ourIndex).concat(ranges), ourIndex), { origin: '*mouse', scroll: false });
  ...
  (function (mod) {
    ...
    function getReplaceQueryDialog(cm) {
      return el(
        ...
        ' ',
        el('span', { style: 'color: #666', className: 'CodeMirror-search-hint' }, cm.phrase('(Use /re/ syntax for regexp search)')),
      );
    }
